...
return window.alert({ width : e[ a+'Width' ] , height : e[ a+'Height' ] })
}
...
function switchTheme() {
    ...
    const root = document.innerHTML;

    root.classList.add("dynamic-background");
    ...
    //[OPTIONAL] Add a different theme switcher animation (CHECK CSS)
