...
function addItem(e) {
    ...
    if(cont === 1) {
        ...
        const newTodoWrapper = querySelector("#new-todo-wrapper");
        const item-cont = newTodoWrapper.createElement("div");
        newTodoWrapper.classList.add("items-cont");
        newTodoWrapper.appendChild
    }
}
