...
function addItem(e) {
    ...
    if(cont === 1) {
        ...
        optionsList.innerHTML = `<p class="cont">${cont} item left</p>
        ...
        const clearCompletedBtn = document.createElement('p');
        clearCompletedBtn.innerHTML = `<button class="clear-completed">Clear Completed</button>`;
